const extensionName = "Zarban's Grotto";
const version = "1.0.0";
const author = "rscarson";
class LavendeuxInteger extends Number {
  constructor(value) {
  ...
  static fromValue(value) {
    let _value = value.Integer !== void 0 ? value.Integer : value.Float;
    if (_value === void 0)
      throw new Error("expected an integer or a float");
    return new LavendeuxInteger(_value);
  }
}
class LavendeuxFloat extends Number {
  constructor(value) {
    super(1 * value);
  }
  /**
   ...
   */
  static fromValue(value) {
    let _value = value.Float !== void 0 ? value.Float : value.Integer;
    if (_value === void 0)
      throw new Error("expected an integer or a float");
    return new LavendeuxFloat(_value);
  }
}
class LavendeuxString extends String {
  constructor(value) {
    super(`${value}`);
  }
  /**
...
class LavendeuxBoolean extends Boolean {
  constructor(value) {
    super(value);
  }
  /**
...
class LavendeuxArray extends Array {
  constructor(value) {
    super();
   ...
   */
  toValue() {
    return { "Array": this.map((e) => e.toValue()) };
  }
  /**
   * Instantiate the value from a Lavendeux function argument
   * @param {Value} value 
...
class LavendeuxValue {
  ...
  constructor(value) {
    switch (Object.keys(value)[0]) {
      case "Integer":
        return LavendeuxValue.asInteger(value);
      case "Float":
        return LavendeuxValue.asFloat(value);
      case "Boolean":
        return LavendeuxValue.asBoolean(value);
      case "String":
        return LavendeuxValue.asString(value);
      case "Array":
        return LavendeuxValue.asArray(value);
      default:
        throw new Error(`Unrecognized type ${Object.keys(value)[0]}. Is this template out of date?`);
    }
  }
  /**
...
class Interface {
  ...
  static getPlayerDetailString(player, debug = false) {
    ...
    for (const s of debug ? player.status.list() : player.status.list_visible()) {
      ...
      output.push(`${name} : ${status2.value} / ${status2.maximum}`);
    }
